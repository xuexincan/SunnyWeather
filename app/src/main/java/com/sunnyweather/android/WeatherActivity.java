...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        ...
        String weatherUrl = "https://free-api.heweather.net/s6/weather?location=" +
                weatherId + "&key=96bcde75f1a54039a8ba3240cdf6826c";
    ...
    private void showWeatherInfo(Weather weather){
        ...
        String updateTime = weather.update.lock.split(" ")[1];
        String degree = weather.now.temperature + "℃";
        String weatherInfo = weather.now.description;
        ...
        for(Forecast forecast : weather.forecastList){
            ...
            aqiText.setText(weather.now.humidity);
            pm25Text.setText(weather.now.pressure);
        }
        String comfort = null;
        String carWash = null;
        String sport = null;
        Log.d("WeatherActivity", weather.lifestyleList.size() + "");
        for(int i = 0; i < weather.lifestyleList.size(); i++){
            Lifestyle lifestyle = weather.lifestyleList.get(i);
            switch (lifestyle.type) {
                case "comf":
                    comfort = "舒适度：" + lifestyle.suggestTxt;
                    Log.d("WeatherActivity", comfort);
                    break;
                case "cw":
                    carWash = "洗车指数：" + lifestyle.suggestTxt;
                    break;
                case "sport":
                    sport = "运动建议：" + lifestyle.suggestTxt;
                    break;
                default:
            }
        }
